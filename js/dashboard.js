window.dashboard = {
    ...
    updateTimerDisplay() {
        document.getElementById('dash-timer').innerText = window.timer.formatTime(window.gameState.timeSeconds);
    },
    highlightActiveTurn() {
        ...
        if (window.gameState.activeTurn === 1) {
            ...
            badgeP2.classList.add('active'); badgeP1.classList.remove('active');
        }
    }
};